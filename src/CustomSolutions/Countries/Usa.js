...
const Usa = () => {
    ...
    return (
        <div>
            <div style={{backgroundImage: 'url(https://www.lamborghini.com/sites/it-en/files/DAM/lamborghini/financial/2021/usa/lfs_usa_hero_01_0.jpg)', backgroundPosition: 'center'}} ref={startRef} className="fin-services" onMouseOver={mouseOver}>
            ...
            <div ref={ref} className="fin-services-content3">
                ...
                <div className="a">
                    <img src="https://www.lamborghini.com/sites/it-en/files/DAM/lamborghini/financial/2021/usa/s/lfs_usa_s_01_m.jpg" className="fin-services-content3-img"/>
                </div>
            </div>
            <div className="fin-services-content4">
                <div className="fin-services-content4-img1-div">
                    <img src="https://www.lamborghini.com/sites/it-en/files/DAM/lamborghini/financial/2021/usa/s/lfs_usa_s_03.jpg" className="fin-services-content4-img1"/>
                </div>
            ...
            <div style={{display: 'flex', justifyContent: 'start'}} className="fin-services-content5">
                <div className="fin-services-content5-img-div">
                    <img src="https://www.lamborghini.com/sites/it-en/files/DAM/lamborghini/financial/2021/russia/over/lfs_russia_over_rev_01.jpg" className="fin-services-content5-img"/>
                </div>
            ...
            <div style={{display: 'flex', justifyContent: 'start'}} className="fin-services-content5">
                <div className="fin-services-content5-img-div">
                    <img style={{width: '1200px', height: '700px'}} src="https://www.lamborghini.com/sites/it-en/files/DAM/lamborghini/financial/2021/usa/over/corrette/lfs_usa_over_rev_01.jpg" className="fin-services-content5-img"/>
                </div>
                <div className="fin-services-content5-texts">
                    <div className="fin-services-content5-title">
                        RETAIL FINANCING
